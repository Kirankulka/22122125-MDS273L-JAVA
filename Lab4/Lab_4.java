...
public class Lab_4 {
    ...
    public Lab_4(String accountNumber, String accountHolderName, double accountBalance) {
    ...
    public static void main(String[] args) {
        ...
        Lab_4 bankAccount = new Lab_4(accountNumber, accountHolderName, accountBalance);
